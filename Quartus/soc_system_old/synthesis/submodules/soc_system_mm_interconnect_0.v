...
module soc_system_mm_interconnect_0 (
	...
	wire  [114:0] realtime_clock_controll_0_avalon_slave_agent_rf_source_data;                // realtime_clock_controll_0_avalon_slave_agent:rf_source_data -> realtime_clock_controll_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [114:0] realtime_clock_controll_0_avalon_slave_agent_rsp_fifo_out_data;             // realtime_clock_controll_0_avalon_slave_agent_rsp_fifo:out_data -> realtime_clock_controll_0_avalon_slave_agent:rf_sink_data
	...
	wire  [113:0] realtime_clock_controll_0_avalon_slave_agent_rp_data;                       // realtime_clock_controll_0_avalon_slave_agent:rp_data -> router_002:sink_data
	...
	wire          fpga_key_s1_agent_rp_valid;                                                 // fpga_key_s1_agent:rp_valid -> router_003:sink_valid
	wire  [113:0] fpga_key_s1_agent_rp_data;                                                  // fpga_key_s1_agent:rp_data -> router_003:sink_data
	wire          fpga_key_s1_agent_rp_ready;                                                 // router_003:sink_ready -> fpga_key_s1_agent:rp_ready
	wire          fpga_key_s1_agent_rp_startofpacket;                                         // fpga_key_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          fpga_key_s1_agent_rp_endofpacket;                                           // fpga_key_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          fpga_led_s1_agent_rp_valid;                                                 // fpga_led_s1_agent:rp_valid -> router_004:sink_valid
	wire  [113:0] fpga_led_s1_agent_rp_data;                                                  // fpga_led_s1_agent:rp_data -> router_004:sink_data
	wire          fpga_led_s1_agent_rp_ready;                                                 // router_004:sink_ready -> fpga_led_s1_agent:rp_ready
	wire          fpga_led_s1_agent_rp_startofpacket;                                         // fpga_led_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          fpga_led_s1_agent_rp_endofpacket;                                           // fpga_led_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire   [95:0] piezo_controller_0_s1_agent_rp_data;                                        // piezo_controller_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [113:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> realtime_clock_controll_0_avalon_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                          // realtime_clock_controll_0_avalon_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> realtime_clock_controll_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire  [113:0] realtime_clock_controll_0_avalon_slave_burst_adapter_source0_data;          // realtime_clock_controll_0_avalon_slave_burst_adapter:source0_data -> realtime_clock_controll_0_avalon_slave_agent:cp_data
	...
	wire    [3:0] realtime_clock_controll_0_avalon_slave_burst_adapter_source0_channel;       // realtime_clock_controll_0_avalon_slave_burst_adapter:source0_channel -> realtime_clock_controll_0_avalon_slave_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                                      // cmd_mux_001:src_valid -> fpga_key_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> fpga_key_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                      // fpga_key_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> fpga_key_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                              // cmd_mux_001:src_startofpacket -> fpga_key_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                // cmd_mux_001:src_endofpacket -> fpga_key_s1_burst_adapter:sink0_endofpacket
	...
	wire    [3:0] fpga_key_s1_burst_adapter_source0_channel;                                  // fpga_key_s1_burst_adapter:source0_channel -> fpga_key_s1_agent:cp_channel
	...
	wire          cmd_mux_002_src_valid;                                                      // cmd_mux_002:src_valid -> fpga_led_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> fpga_led_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                      // fpga_led_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> fpga_led_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                              // cmd_mux_002:src_startofpacket -> fpga_led_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                // cmd_mux_002:src_endofpacket -> fpga_led_s1_burst_adapter:sink0_endofpacket
	...
	wire    [3:0] fpga_led_s1_burst_adapter_source0_channel;                                  // fpga_led_s1_burst_adapter:source0_channel -> fpga_led_s1_agent:cp_channel
	...
	wire   [95:0] router_005_src_data;                                                        // router_005:src_data -> piezo_controller_0_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                       // piezo_controller_0_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [3:0] router_005_src_channel;                                                     // router_005:src_channel -> piezo_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire  [113:0] piezo_controller_0_s1_rsp_width_adapter_src_data;                           // piezo_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	...
	wire  [113:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> piezo_controller_0_s1_cmd_width_adapter:in_data
	...
	wire          fpga_key_s1_agent_rdata_fifo_out_valid;                                     // fpga_key_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] fpga_key_s1_agent_rdata_fifo_out_data;                                      // fpga_key_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          fpga_key_s1_agent_rdata_fifo_out_ready;                                     // avalon_st_adapter_001:in_0_ready -> fpga_key_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                                          // avalon_st_adapter_001:out_0_valid -> fpga_key_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                           // avalon_st_adapter_001:out_0_data -> fpga_key_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                          // fpga_key_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                          // avalon_st_adapter_001:out_0_error -> fpga_key_s1_agent:rdata_fifo_sink_error
	wire          fpga_led_s1_agent_rdata_fifo_out_valid;                                     // fpga_led_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] fpga_led_s1_agent_rdata_fifo_out_data;                                      // fpga_led_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          fpga_led_s1_agent_rdata_fifo_out_ready;                                     // avalon_st_adapter_002:in_0_ready -> fpga_led_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                                          // avalon_st_adapter_002:out_0_valid -> fpga_led_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                           // avalon_st_adapter_002:out_0_data -> fpga_led_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                          // fpga_led_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                          // avalon_st_adapter_002:out_0_error -> fpga_led_s1_agent:rdata_fifo_sink_error
	wire          piezo_controller_0_s1_agent_rdata_fifo_out_valid;                           // piezo_controller_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [17:0] piezo_controller_0_s1_agent_rdata_fifo_out_data;                            // piezo_controller_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          piezo_controller_0_s1_agent_rdata_fifo_out_ready;                           // avalon_st_adapter_003:in_0_ready -> piezo_controller_0_s1_agent_rdata_fifo:out_ready
