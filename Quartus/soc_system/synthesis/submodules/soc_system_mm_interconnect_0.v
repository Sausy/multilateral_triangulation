...
module soc_system_mm_interconnect_0 (
	...
	wire          fpga_key_s1_agent_rp_valid;                                                 // fpga_key_s1_agent:rp_valid -> router_004:sink_valid
	wire  [115:0] fpga_key_s1_agent_rp_data;                                                  // fpga_key_s1_agent:rp_data -> router_004:sink_data
	wire          fpga_key_s1_agent_rp_ready;                                                 // router_004:sink_ready -> fpga_key_s1_agent:rp_ready
	wire          fpga_key_s1_agent_rp_startofpacket;                                         // fpga_key_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          fpga_key_s1_agent_rp_endofpacket;                                           // fpga_key_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          fpga_led_s1_agent_rp_valid;                                                 // fpga_led_s1_agent:rp_valid -> router_005:sink_valid
	wire  [115:0] fpga_led_s1_agent_rp_data;                                                  // fpga_led_s1_agent:rp_data -> router_005:sink_data
	wire          fpga_led_s1_agent_rp_ready;                                                 // router_005:sink_ready -> fpga_led_s1_agent:rp_ready
	wire          fpga_led_s1_agent_rp_startofpacket;                                         // fpga_led_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          fpga_led_s1_agent_rp_endofpacket;                                           // fpga_led_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          piezo_controller_0_s1_agent_rp_valid;                                       // piezo_controller_0_s1_agent:rp_valid -> router_006:sink_valid
	wire   [97:0] piezo_controller_0_s1_agent_rp_data;                                        // piezo_controller_0_s1_agent:rp_data -> router_006:sink_data
	wire          piezo_controller_0_s1_agent_rp_ready;                                       // router_006:sink_ready -> piezo_controller_0_s1_agent:rp_ready
	wire          piezo_controller_0_s1_agent_rp_startofpacket;                               // piezo_controller_0_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          piezo_controller_0_s1_agent_rp_endofpacket;                                 // piezo_controller_0_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire    [4:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> realtime_clock_controll_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire    [4:0] realtime_clock_controll_0_avalon_slave_burst_adapter_source0_channel;       // realtime_clock_controll_0_avalon_slave_burst_adapter:source0_channel -> realtime_clock_controll_0_avalon_slave_agent:cp_channel
	...
	wire    [4:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> ptp_simple_us_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire    [4:0] ptp_simple_us_0_avalon_slave_burst_adapter_source0_channel;                 // ptp_simple_us_0_avalon_slave_burst_adapter:source0_channel -> ptp_simple_us_0_avalon_slave_agent:cp_channel
	...
	wire          cmd_mux_002_src_valid;                                                      // cmd_mux_002:src_valid -> fpga_key_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> fpga_key_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                      // fpga_key_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> fpga_key_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                              // cmd_mux_002:src_startofpacket -> fpga_key_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                // cmd_mux_002:src_endofpacket -> fpga_key_s1_burst_adapter:sink0_endofpacket
	...
	wire    [4:0] fpga_key_s1_burst_adapter_source0_channel;                                  // fpga_key_s1_burst_adapter:source0_channel -> fpga_key_s1_agent:cp_channel
	...
	wire          cmd_mux_003_src_valid;                                                      // cmd_mux_003:src_valid -> fpga_led_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> fpga_led_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                      // fpga_led_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> fpga_led_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                              // cmd_mux_003:src_startofpacket -> fpga_led_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                // cmd_mux_003:src_endofpacket -> fpga_led_s1_burst_adapter:sink0_endofpacket
	...
	wire    [4:0] fpga_led_s1_burst_adapter_source0_channel;                                  // fpga_led_s1_burst_adapter:source0_channel -> fpga_led_s1_agent:cp_channel
	...
	wire          router_006_src_valid;                                                       // router_006:src_valid -> piezo_controller_0_s1_rsp_width_adapter:in_valid
	wire   [97:0] router_006_src_data;                                                        // router_006:src_data -> piezo_controller_0_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                       // piezo_controller_0_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [4:0] router_006_src_channel;                                                     // router_006:src_channel -> piezo_controller_0_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                               // router_006:src_startofpacket -> piezo_controller_0_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                                 // router_006:src_endofpacket -> piezo_controller_0_s1_rsp_width_adapter:in_endofpacket
	...
	wire  [115:0] piezo_controller_0_s1_rsp_width_adapter_src_data;                           // piezo_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	...
	wire  [115:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> piezo_controller_0_s1_cmd_width_adapter:in_data
	...
	wire          fpga_key_s1_agent_rdata_fifo_out_valid;                                     // fpga_key_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] fpga_key_s1_agent_rdata_fifo_out_data;                                      // fpga_key_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          fpga_key_s1_agent_rdata_fifo_out_ready;                                     // avalon_st_adapter_002:in_0_ready -> fpga_key_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                                          // avalon_st_adapter_002:out_0_valid -> fpga_key_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                           // avalon_st_adapter_002:out_0_data -> fpga_key_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                          // fpga_key_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                          // avalon_st_adapter_002:out_0_error -> fpga_key_s1_agent:rdata_fifo_sink_error
	wire          fpga_led_s1_agent_rdata_fifo_out_valid;                                     // fpga_led_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] fpga_led_s1_agent_rdata_fifo_out_data;                                      // fpga_led_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          fpga_led_s1_agent_rdata_fifo_out_ready;                                     // avalon_st_adapter_003:in_0_ready -> fpga_led_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                                          // avalon_st_adapter_003:out_0_valid -> fpga_led_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                           // avalon_st_adapter_003:out_0_data -> fpga_led_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                          // fpga_led_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                          // avalon_st_adapter_003:out_0_error -> fpga_led_s1_agent:rdata_fifo_sink_error
	wire          piezo_controller_0_s1_agent_rdata_fifo_out_valid;                           // piezo_controller_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [17:0] piezo_controller_0_s1_agent_rdata_fifo_out_data;                            // piezo_controller_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          piezo_controller_0_s1_agent_rdata_fifo_out_ready;                           // avalon_st_adapter_004:in_0_ready -> piezo_controller_0_s1_agent_rdata_fifo:out_ready
