...
/*
 ...
 This example demonstrat es the use of both spi_device_transmit as well as
...
extern "C" void app_main()
{
    ...
    spi_bus_config_t buscfg={PIN_NUM_MOSI,PIN_NUM_MISO,PIN_NUM_CLK,PIN_NUM_WP,PIN_NUM_HD,PARALLEL_LINES*320*2+8};//,0,0,0}; //.max_transfer_sz=PARALLEL_LINES*320*2+8  <= could be added
...
spi_device_interface_config_t devcfg={ //0,0,0,0,0,0,0,26*1000*1000,PIN_NUM_CS,0,7};
  ...
  lcd_spi_pre_transfer_callback    //< Callback to be called before a transmission is started. This callback is called within interrupt context.
  };
